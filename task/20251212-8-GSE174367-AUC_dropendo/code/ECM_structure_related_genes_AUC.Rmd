...
write.csv(auc_combined, "../Documents/Structure_gene_list_AUC_per_subclass.csv", row.names = FALSE)
```
...
# 热图参数设置（优化可读性）
pdf("../plot/Structure_gene_list_AUC_heatmap_per_subclass.pdf", width = 14, height = 8)
pheatmap(
  auc_matrix,
