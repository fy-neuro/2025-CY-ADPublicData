...
gene_list <- ECM_structure_genes[[1]]
```
...
write.csv(auc_combined, "../Documents/Sturcture_gene_list_AUC_per_subclass.csv", row.names = FALSE)
```
...
# 热图参数设置（优化可读性）
pdf("../plot/Sturcture_gene_list_AUC_heatmap_per_subclass.pdf", width = 14, height = 8)
pheatmap(
  auc_matrix,
  main = "AUC of ECM Structure Associated Genes Across Cell Types",
