# Pseudobulk Analysis with Detailed Logging - Fixed
...
run_pseudobulk_debug <- function(seurat_obj, genes_of_interest, min_cells = 10) {
  ...
  for (ct in cell_types) {
    ...
    tryCatch({
      ...
      cat("Original count matrix dimensions:", paste(dim(count_matrix), collapse = "x"), "\n")
      ...
      cat("Filtered count matrix dimensions:", paste(dim(count_matrix), collapse = "x"), "\n")
      ...
      cat("Count matrix after gene filtering:", paste(dim(count_matrix), collapse = "x"), "\n")
      ...
      cat("DGEList counts dimensions:", paste(dim(dge$counts), collapse = "x"), "\n")
      ...
      cat("DGEList after filtering:", paste(dim(dge), collapse = "x"), "\n")
      ...
      cat("Dimensions:", paste(dim(design), collapse = "x"), "\n")
      cat("Row names:", paste(rownames(design), collapse = ", "), "\n")
      ...
      cat("  DGEList column names:", paste(colnames(dge), collapse = ", "), "\n")
      ...
      if ("AD" %in% levels(group) && "HC" %in% levels(group)) {
        ...
        cat("Available groups:", paste(levels(group), collapse = ", "), "\n")
      }
